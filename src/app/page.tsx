    ...
    <div className="flex flex-col items-center min-h-[calc(100vh-2.5rem)] p-4 sm:p-8">
      <main className="flex flex-col items-center max-w-4xl w-full gap-6">
        ...
        <div className="text-center space-y-4 pt-8">
          <h1 className={`${isMobile ? 'text-3xl' : 'text-5xl'} sm:text-6xl font-bold text-foreground`}>
            Welcome to ChessKit
          </h1>
          <p className={`${isMobile ? 'text-md' : 'text-xl'} sm:text-2xl text-foreground/70`}>
        ...
        <div className="grid md:grid-cols-2 gap-6 w-full mt-8">
          ...
          <Link
            href="/openings"
            className="group p-6 rounded-lg bg-background-page border border-foreground/10 hover:border-color-btn-primary transition-all hover:shadow-lg no-underline"
          >
